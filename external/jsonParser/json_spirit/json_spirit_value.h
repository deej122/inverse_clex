...
namespace json_spirit
{
    ...
    :   v_( Null() ), force_column_(false), force_row_(false)
    {
    }

    template< class Config >
    Value_impl< Config >::Value_impl( const Const_str_ptr value )
    :  v_( String_type( value ) ), force_column_(false), force_row_(false)
    {
    }

    template< class Config >
    Value_impl< Config >::Value_impl( const String_type& value )
    :   v_( value ), force_column_(false), force_row_(false)
    {
    }
    ...
    :   v_( static_cast< boost::int64_t >( value ) ), force_column_(false), force_row_(false)
    {
    }
    ...
    :   v_( other.v_ ), force_column_(other.force_column_), force_row_(other.force_row_)
    {
    }
    ...
    :   v_( Array( first, last ) ), force_column_(false), force_row_(false)
    {
    }
    ...
    :   v_( boost::apply_visitor( Variant_converter_visitor(), variant) ), force_column_(false), force_row_(false)
    {
    }
